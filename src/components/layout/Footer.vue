...
<div id="footer" role="contentinfo">
    <div class="left">
        <h2 class="tit">ME2DESIGNER</h2>
        <p class="desc">궁금하신 내용은 이메일 또는 카카오톡 오픈채팅으로 문의해주세요</p>
        <div class="list_sns">
            ...
            <a class="link_sns" href="https://www.instagram.com/hymt18" target="_blank" title="인스타그램"><img class="instagram" src="" data-images-path="/images/sns/facebook02.svg"></a>
            <a class="link_sns" href="https://www.facebook.com/me2designer" target="_blank" title="인스타그램"><img class="instagram" src="" data-images-path="/images/sns/instagram02.svg"></a>
